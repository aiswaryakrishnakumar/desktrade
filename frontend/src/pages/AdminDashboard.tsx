...
// //   // Delete handler (DELETE /api/items/{id})
// //   const handleDelete = async (itemId: any) => {
// //     if (!confirm('Delete this item permanently? This cannot be undone.')) return;
// //     setItemActionLoading(itemId, true);
// //     try {
// //       const url = `${(import.meta as any).env?.VITE_API_BASE || ''}/api/items/${itemId}`;
// //       const res = await fetch(url, { method: 'DELETE', headers: getAuthHeaders() });
// //       if (!res.ok) {
// //         let body = null;
// //         try { body = await res.json(); } catch {}
// //         throw new Error((body && body.message) || `Delete failed: ${res.status}`);
// //       }
...
// //     // ask quantity or any details you need
...
// //     setItemActionLoading(itemId, true);
// //     try {
// //       // TODO: Replace this placeholder with a real booking API call.
// //       // Example (if you add a booking endpoint): await bookItem(itemId, { quantity: qty });

// //       // For now, update local UI to indicate booking happened
...
// //                         <div className="item-thumb" style={{ backgroundImage: `url(${it.image || '/assets/default.png'})`, minWidth: 120, minHeight: 80 }} />
// //                         <div style={{ flex: 1 }}>
...
// //                           {/* Action buttons - replaced Delete & View with single "Book Item" */}
